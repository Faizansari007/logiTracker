            ...
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
                  Welcome to logi<span className="text-blue-800">Tracker </span>
                </h1>
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  Here you can exchange crypto with the blockchain you need. The best platform for buy or sell Cryptocurrency. Empower your financial journey with logiTracker.
                </p>
                ...
                "Welcome to the forefront of digital finance. Discover a next-generation cryptocurrency platform built with cutting-edge technology. Our solution leverages the power of JavaScript, React, ExpressJS, Tailwind CSS, and MongoDB to deliver a seamless, secure, and scalable experience. Whether you're trading, investing, or exploring the potential of digital currencies, our platform offers a user-friendly interface, lightning-fast transactions, and robust security features to meet all your needs. Join us in shaping the future of finance with innovative solutions designed to empower you at every step. Trust in our technology to power your cryptocurrency journey with innovation and excellence."
                </p>
              </div>
            ...
            <div className="container mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    <p className="font-semibold text-xl">Invest in NFTs</p>
                    <p className="mt-4">
                      Investing in NFTs is a great way to diversify your portfolio and gain exposure to the burgeoning digital asset space.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
                  >
                    <p className="font-semibold text-xl">Security and privacy</p>
                    <p className="mt-4">
                      Securely storing and managing funds is one of the most important elements of logiTracker.
                    </p>
                  </div>
                </div>
                <div className="flex-1 px-3">
                  ...
                  >
                    ...
                    <p className="mt-4">
                      You can seek answers to your questions by contacting logiTracker customer support 24/7.
                    </p>
                  </div>
                </div>
              </div>
